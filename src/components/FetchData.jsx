...
const FetchData = ({cat}) => {
    ...
    const FetchData = async () => {
        await axios.get(
            cat ? `https://newsapi.org/v2/top-headlines?country=in&category=${cat}&apiKey=80341ce997034709bbdf74f677de70d7` :
            "https://newsapi.org/v2/top-headlines?country=in&category=bussiness&apiKey=80341ce997034709bbdf74f677de70d7")
            ...
            {data ? data.map((items, index) => (
                <div key={items.url}> 
                    <div className="container my-3 p-3" style={{width:"600px", boxShadow:"2px 2px 10px silver", borderRadius:"10px"}}>
                        ...
                        alt="Image not found" 
                        className="img-fluid" 
                        style={{width:"100%", height:"300px", objectFit:"cover"}}/></div>
                    <p>{items.content}</p>
